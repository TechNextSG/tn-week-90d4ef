...
Client-facing prose that is per-week rather than per-session. Safe to edit.
...
| day | label |
|-----|-------|
| mon | Monday 31 August |
| tue | Tuesday 1 September |
| wed | Wednesday 2 September |
| thu | Thursday 3 September |
| fri | Friday 4 September |

## What we need from you

One card each on the page, in this order.

| what | detail |
|------|--------|
| One room | A table and enough seats for whoever is listed against that block. A quiet corner of the restaurant outside service hours is fine. |
